import {
  ...
  import { LineChart, XAxis, CartesianGrid, Line, Tooltip,  AreaChart, Area, YAxis } from 'recharts'
    ...
    return (
      <BasePage className={classes.root}>
        ...
        <Container maxWidth="lg" className={classes.container}>
           <Typography style={{fontWeight:"bold"}}>CHARTS TEMPLATE PAGE (MOCK DATA)</Typography> 
